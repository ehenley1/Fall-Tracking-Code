...
def main():
    ...
    parser.add_argument('--use-multi-frames', action='store_true', default=False, help='whether to use multi frames for inference in the pose estimation stage. Default: False.')
    parser.add_argument('--online', action='store_true', default=False, help='inference mode. If set to True, can not use future frame information when using multi frames for inference in the pose estimation stage. Default: False.')

    args = parser.parse_args()

    # Location where videos exist
    video_directory = "C:/Users/lazyp/Fall_Tracker/Videos"
    ...
    for video_name in video_names:
        ...
        output_path = os.path.join(video_directory, video_name.replace(".mp4", ""))
